...
LOCAL_CPPFLAGS := -DLEVELDB_PLATFORM_ANDROID -std=c++11
LOCAL_CFLAGS := -DLEVELDB_PLATFORM_ANDROID -std=c++11
...
LOCAL_CFLAGS := -D_REENTRANT -DOS_ANDROID -DLEVELDB_PLATFORM_POSIX -DNDEBUG -DSNAPPY -std=c++11
LOCAL_CPPFLAGS := -D_REENTRANT -DOS_ANDROID -DLEVELDB_PLATFORM_POSIX -DNDEBUG -DSNAPPY -std=c++11
LOCAL_CPP_EXTENSION := .cc
